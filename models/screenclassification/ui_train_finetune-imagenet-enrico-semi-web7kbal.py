if __name__ == "__main__":
    ...
    ARTIFACT_DIR = "checkpoints_screenclassification_enrico-webui-silver-web7kbal"
    ...
    data = SilverDataModule(silver_id_list_path="../screenrecognition/train_split_web7kbal.json", K=700)
