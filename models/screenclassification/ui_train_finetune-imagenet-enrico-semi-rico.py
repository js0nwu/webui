if __name__ == "__main__":
    ...
    ARTIFACT_DIR = "checkpoints_screenclassification_enrico-webui-silver-rico"
    ...
    data = SilverDataModule(silver_id_list_path=None, img_folder="../../downloads/rico/combined", silver_csv="../../metadata/screenclassification/silver_rico-multi_topic.csv", silver_id_list_path_ignores=["../../metadata/screenclassification/filtered_train_ids.json", "../../metadata/screenclassification/filtered_val_ids.json", "../../metadata/screenclassification/filtered_test_ids.json"], K=7000)
